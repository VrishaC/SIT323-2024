...
const div= (n1,n2) => {
  if(n2 == 0)
  {
    throw new Error("Division by zero is not applicable!");
  }
  return n1/n2;
}
...
const sqrt= (n1) => {
  if(n1 < 0)
  {
    throw new Error("Square root of negative numbers are not applicable!")
  }
  return Math.sqrt(n1);
}
...
app.get("/sqrt", (req,res)=>{
  ...
  logger.info('Parameter '+n1+' received for square root operations');
...
app.get("/mod", (req,res)=>{
  ...
  logger.info('Parameters '+n1+' and '+n2+' received for modulus operations');
